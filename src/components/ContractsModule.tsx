    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white  p-5 rounded-xl border border-slate-200  shadow-sm">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-white  hover:bg-slate-50 :bg-slate-700 text-slate-700  text-xs font-semibold rounded-lg border border-slate-200  transition-all shadow-sm"
          >
        ...
        <button
          ...
          className={`pb-3 text-sm font-bold border-b-2 transition-all flex items-center gap-2 ${
            activeTab === 'contracts'
              ...
              : 'border-transparent text-slate-500 hover:text-slate-800 :text-white'
          }`}
        >
      ...
      {activeTab === 'contracts' && (
        <div className="bg-white  rounded-xl border border-slate-200  shadow-sm overflow-hidden">
          <div className="p-3.5 border-b border-slate-200  flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 bg-slate-50  border border-slate-200  rounded-lg text-xs text-slate-900  focus:outline-none focus:ring-1 focus:ring-[#091426]"
              />
            </div>
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-slate-200 ">
                {contracts
                  ...
                  .map((contract) => (
                    <tr key={contract.id} className="hover:bg-slate-50 :bg-slate-800/40 transition-colors">
                      ...
                      <td className="px-5 py-3.5">
                        <div className="text-slate-800  font-medium">{contract.propertyAddress}</div>
                      ...
                      <td className="px-5 py-3.5">
                        <div className="font-semibold text-slate-800  font-mono">{contract.nextAdjustmentDate}</div>
                        <div className="text-[10px] text-slate-400 capitalize">{contract.adjustmentFrequency}</div>
                      </td>

                      <td className="px-5 py-3.5">
                        <span className="px-2 py-0.5 bg-[#F2F4F6]  text-[#091426]  border border-[#E6E8EA]  rounded font-mono font-bold text-[10px]">
                          {contract.indexType}
                        </span>
                      </td>
                      ...
                      <td className="px-5 py-3.5 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            ...
                            className="px-2.5 py-1.5 bg-[#F2F4F6]  text-[#091426]  border border-[#E6E8EA]  hover:bg-[#E6E8EA] font-semibold rounded-lg transition-all flex items-center gap-1 text-xs"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 text-slate-500 hover:text-slate-800 :text-white rounded-lg hover:bg-slate-100 :bg-slate-800 transition-colors"
      ...
      {selectedContractForCalc && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white  w-full max-w-lg rounded-xl overflow-hidden border border-slate-200  shadow-2xl">
            {/* Modal Header */}
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    >
                      <div className="font-bold text-xs text-slate-900 ">{idx.name}</div>
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-xs font-bold font-mono text-[#091426] ">
                    +{calcPercentage}%
                  </span>
                </div>
                <input
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-50  border border-slate-200  rounded-lg text-xs text-slate-900  focus:outline-none focus:ring-1 focus:ring-[#091426] font-mono"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-slate-700  mb-1">
