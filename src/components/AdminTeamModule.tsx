    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white  p-4 rounded-xl border border-slate-200  shadow-sm">
          ...
          <p className="text-xs text-[#091426]  font-medium mt-0.5">Depto. Judicial Junín</p>
        </div>
        ...
        <div className="bg-white  p-4 rounded-xl border border-slate-200  shadow-sm">
          ...
          <h3 className="text-sm font-bold text-slate-900  mt-1 uppercase text-[#091426] ">
            {currentTenant.plan}
          </h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-200 ">
              {users.map((u) => (
                <tr key={u.id} className="hover:bg-slate-50 :bg-slate-800/40 transition-colors">
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-slate-200  flex items-center justify-center font-bold text-slate-700  overflow-hidden text-xs">
                        {u.avatar ? (
                  ...
                  <td className="px-5 py-3">
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${
                      ...
                      u.role === 'martillero' ? 'bg-[#F2F4F6] text-[#091426]   border border-[#E6E8EA] ' :
                      u.role === 'cobranzas' ? 'bg-amber-50 text-amber-700   border border-amber-200 ' :
      ...
      <div className="bg-white  p-5 rounded-xl border border-slate-200  shadow-sm">
        <h3 className="font-bold text-xs uppercase tracking-wider text-slate-900  mb-3">
          Matriz de Permisos por Rol (RBAC)
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-xs">
          <div className="p-3.5 bg-slate-50  rounded-lg border border-slate-200 ">
            <span className="font-bold text-purple-600  block mb-1">Administrador / Titular</span>
          ...
          <div className="p-3.5 bg-slate-50  rounded-lg border border-slate-200 ">
            <span className="font-bold text-[#091426]  block mb-1">Martillero / Ventas</span>
            <p className="text-slate-500 text-[11px] leading-relaxed">
          ...
          <div className="p-3.5 bg-slate-50  rounded-lg border border-slate-200 ">
            <span className="font-bold text-amber-600  block mb-1">Cobranzas</span>
            <p className="text-slate-500 text-[11px] leading-relaxed">
          ...
          <div className="p-3.5 bg-slate-50  rounded-lg border border-slate-200 ">
            <span className="font-bold text-green-600  block mb-1">Inquilino (Portal Móvil)</span>
            <p className="text-slate-500 text-[11px] leading-relaxed">
      ...
      {isInviteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white  w-full max-w-md rounded-xl p-5 border border-slate-200  shadow-xl">
