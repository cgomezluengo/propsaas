...
export const DashboardCRMModule: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-6 animate-fadeIn text-[#191C1E]">
      ...
      {showGuideBanner && (
        <div className="bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200/80 dark:border-blue-900/50 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="text-xs text-blue-700 dark:text-blue-400 hover:underline font-semibold shrink-0"
          >
            Entendido ✕
          </button>
        </div>
                    ...
                    <div>
                      ...
                      <div className="flex justify-between items-center mb-2">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300">
                            {lead.channel}
                          </span>
                      ...
                      <div className="mt-3 pt-2.5 border-t border-slate-200/60 dark:border-slate-700/60 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg flex items-center gap-1 shadow-sm"
                          >
                ...
                >
                  ...
                  <div className="mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-700/60 flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 px-2.5 py-1 rounded flex items-center gap-1 shadow-sm"
                    >
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-slate-700 dark:text-slate-200 font-medium">
                {filteredLeads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="p-3.5">
                      <div className="font-semibold text-blue-600 dark:text-blue-400">{lead.propertyInterest}</div>
      ...
      {whatsappModalLead && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-2xl">
            ...
            <div className="flex justify-between items-center pb-3 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 dark:text-blue-400 font-semibold">{scheduleVisitLead.propertyInterest}</p>
                </div>
              </div>
              <button
            ...
            <div>
              ...
              <div className="mt-4 p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  <button
                    ...
                    className={`py-1.5 text-xs font-bold rounded ${selectedLeadForDetail.status === 'new' ? 'bg-blue-600 text-white' : 'bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300'}`}
                  >
                    1. Nuevo
                  </button>
                  <button
              ...
              <div className="mt-4 space-y-3 text-xs">
                ...
                {selectedLeadForDetail.aiScore && (
                  <div className="p-3 bg-blue-50 dark:bg-blue-950/40 rounded-xl border border-blue-200 dark:border-blue-800 text-blue-900 dark:text-blue-200">
            ...
            <div className="flex gap-2 my-3 p-1 bg-slate-100 dark:bg-slate-800 rounded-lg">
              <button
                ...
                className={`flex-1 py-1 text-xs font-bold rounded-md transition-all ${
                  newLeadMode === 'simple' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow-sm' : 'text-slate-500'
                }`}
              >
                Formulario 3 Campos
              </button>
